...
//    private final AuditLogUserRepository auditLogUserRepository;
    ...
    @Override
    public ApiResponsePagination<List<AuditLogResponse>> getAllAuditLog(AuditLogRequest auditLogRequest) {
...
//                    log.info("Processing audit log:  entityId={}, userId={}, entityName={}, action={},description={}", entityId, userId, entityName, action, description);
//
